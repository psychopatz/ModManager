...
import TagCollectionEditor from './TagCollectionEditor';
      ...
      <Stack spacing={3}>
        <Paper elevation={3} sx={{ p: 3 }}>
          <Stack spacing={2.5} sx={{ mb: 2.5 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" alignItems={{ xs: 'stretch', sm: 'center' }} spacing={2}>
              ...
              <Stack direction="row" spacing={1.25} sx={{ flexShrink: 0 }}>
                ...
                <Button
                  ...
                  sx={{ whiteSpace: 'nowrap', minWidth: 160, px: 2.5 }}
                >
            ...
            {/* Modules Selector chips line */}
            <Stack direction="row" spacing={0.75} flexWrap="wrap" useFlexGap sx={{ pb: 0.5 }}>
              {modules.map(m => (
                <Chip
                  key={m.id}
                  label={m.name}
                    ...
                    {draftWants.length ? draftWants.map((row, index) => (
                      <Paper key={`want-${index}`} variant="outlined" sx={{ p: 1.25 }}>
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.25} alignItems={{ xs: 'stretch', sm: 'center' }}>
                          ...
                          />
                          <Stack direction="row" spacing={1.25} alignItems="center" sx={{ width: { xs: '100%', sm: 'auto' }, flexShrink: 0 }}>
                            <TextField
                              label="Multiplier"
                              type="number"
